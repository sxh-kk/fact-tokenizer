...
RUN_NAME="${RUN_NAME:-v6d_transition48_actionaware_from_v6b_8gpu_$(date +%Y%m%d_%H%M%S)}"
...
# v6b final checkpoint is step 89999. 98000 gives about 8000 targeted continuation steps.
STEPS="${STEPS:-98000}"
