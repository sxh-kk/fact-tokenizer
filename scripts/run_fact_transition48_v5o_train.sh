...
RUN_NAME="${RUN_NAME:-v5o_transition48_from_v5m_action_causality_8gpu_$(date +%Y%m%d_%H%M%S)}"
...
CMD=(
  ...
  --no-private-contrast-weight 0.34
  --zero-action-contrast-weight 0.080
  --no-private-zero-action-contrast-weight 0.140
